...
public class AuthController : BaseController
{
    ...
    [HttpPost("Register")]
    public async Task<IActionResult> Register([FromBody] UserForExtendedRegisterDto userForExtendedRegisterDto)
    {
        RegisterCommand registerCommand = new() { UserForExtendedRegisterDto = userForExtendedRegisterDto, IpAddress = getIpAddress() };
